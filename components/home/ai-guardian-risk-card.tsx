      ...
      <div className="h-full w-full flex flex-col bg-gradient-to-br from-purple-900 to-purple-950 rounded-lg overflow-hidden p-5">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xl font-bold text-white">Professor Shield</h3>
          </div>
        ...
        <div className="flex-1 bg-gray-900/50 rounded-lg p-4 border border-purple-500/20 font-mono text-sm overflow-hidden">
          <div className="space-y-4">
            <div className="flex gap-3">
              <div className="w-8 h-8 rounded-full bg-gray-700 flex items-center justify-center text-sm">👤</div>
              <div className="flex-1 bg-gray-800 rounded-lg p-3">
                <p className="text-gray-300">"We're adopting Claude for customer support. What security risks should I present to my CTO?"</p>
              </div>
            </div>
            <div className="flex gap-3">
      ...
      <div className="h-full w-full flex flex-col bg-gradient-to-br from-orange-900 to-orange-950 rounded-lg overflow-hidden p-5">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xl font-bold text-white">Compliance Hub</h3>
          </div>
        ...
        <div className="flex-1 space-y-3">
          <div className="bg-green-500/20 border border-green-500/40 rounded-lg p-3">
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className="text-gray-400 text-sm">Last audit: Nov 2025</span>
            </div>
            <div className="w-full bg-gray-700 rounded-full h-2">
              <div className="bg-green-500 h-2 rounded-full" style={{ width: "100%" }} />
            </div>
            <p className="text-gray-400 text-sm mt-1.5">✓ DPA signed ✓ Records updated ✓ DPIA completed</p>
          </div>
          <div className="bg-yellow-500/20 border border-yellow-500/40 rounded-lg p-3">
            ...
            <p className="text-gray-400 text-sm mt-1.5">⏳ Incident response plan ⏳ Supply chain assessment</p>
          </div>
          <div className="bg-blue-500/20 border border-blue-500/40 rounded-lg p-3">
            ...
            <p className="text-gray-400 text-sm mt-1.5">📋 Risk classification pending new guidance</p>
          </div>
        </div>
        <div className="mt-3 text-sm text-gray-500">📥 12 templates downloaded this month</div>
      </div>
    ),
  },
  {
      ...
      <div className="h-full w-full flex flex-col bg-gradient-to-br from-green-900 to-green-950 rounded-lg overflow-hidden p-5">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xl font-bold text-white">Threat Dashboard</h3>
          </div>
          <span className="text-sm text-green-300 bg-green-500/20 px-3 py-1 rounded-full">Live</span>
        </div>
        <div className="flex-1 bg-gray-900/50 rounded-lg p-4 border border-green-500/20">
          ...
          <div className="text-sm text-gray-400 mb-3">🇪🇺 Europe Trends (Dec 2025)</div>
          <div className="space-y-2 text-sm">
            <div className="flex justify-between items-center bg-red-500/10 rounded-lg px-3 py-2">
              <span className="text-gray-300">🎯 LLM01 Prompt Injection</span>
            ...
            <div className="flex justify-between items-center bg-yellow-500/10 rounded-lg px-3 py-2">
              <span className="text-gray-300">🔓 LLM06 Data Leakage</span>
            ...
            <div className="flex justify-between items-center bg-green-500/10 rounded-lg px-3 py-2">
              <span className="text-gray-300">⚡ LLM04 Model DoS</span>
      ...
      <div className="h-full w-full flex flex-col bg-gradient-to-br from-cyan-900 to-cyan-950 rounded-lg overflow-hidden p-5">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xl font-bold text-white">Training Library</h3>
          </div>
          <span className="text-sm text-cyan-300 bg-cyan-500/20 px-3 py-1 rounded-full">47 Courses</span>
        </div>
        <div className="flex-1 space-y-3">
          <div className="bg-gray-900/50 rounded-lg p-3 border border-cyan-500/20 hover:border-cyan-500/40 transition-colors">
            <div className="flex items-start justify-between mb-1.5">
              <div>
                ...
                <p className="text-gray-400 text-sm mt-0.5">Shopify, WooCommerce AI assistants • 15 min</p>
              </div>
          ...
          <div className="bg-gray-900/50 rounded-lg p-3 border border-cyan-500/20 hover:border-cyan-500/40 transition-colors">
            <div className="flex items-start justify-between mb-1.5">
              <div>
                ...
                <p className="text-gray-400 text-sm mt-0.5">GPT-4, Claude, Gemini Pro security • 20 min</p>
              </div>
              <span className="text-gray-400 text-sm bg-gray-700 px-2 py-0.5 rounded">0%</span>
            </div>
            <div className="w-full bg-gray-700 rounded-full h-1.5">
          ...
          <div className="bg-gray-900/50 rounded-lg p-3 border border-cyan-500/20 hover:border-cyan-500/40 transition-colors">
            <div className="flex items-start justify-between mb-1.5">
              <div>
                ...
                <p className="text-gray-400 text-sm mt-0.5">Citizen portals, document processing • 12 min</p>
              </div>
        ...
        <div className="mt-3 flex items-center justify-between text-sm">
          <span className="text-gray-500">🎓 3 certificates earned</span>
    ...
    >
      ...
      <div className="container relative mx-auto px-4 max-w-7xl">
        ...
        >
          ...
          <Card
            ref={cardRef}
            className="group relative overflow-hidden border-gray-800 bg-gradient-to-br from-gray-900 via-gray-900 to-gray-950 shadow-2xl"
            style={{
              transformStyle: "preserve-3d",
