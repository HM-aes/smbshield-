    ...
    <section className="w-full py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-xl border border-white/10 bg-black/50 backdrop-blur-xl shadow-2xl"
        >
          {/* Terminal Header */}
          <div className="flex items-center justify-between border-b border-white/10 bg-zinc-950/80 px-4 py-3 backdrop-blur">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-xs text-gray-400">security_monitor.log</span>
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div className="ml-4 rounded border border-red-500/20 bg-red-500/5 p-3 text-red-300">
                  <div className="text-gray-500 mb-1"># Malicious Prompt Detected</div>
              ...
              <motion.div
                ...
                className="ml-4 space-y-1.5 text-gray-300"
              >
                <div>
