  ...
  return (
    <FadeIn delay={(index + 1) * 0.1}>
      ...
      >
        ...
        <div
          className="relative flex h-full flex-col rounded-2xl border border-amber-500/20 p-6 transition-all duration-300 group-hover:border-amber-500/40"
          style={{ 
      ...
      <div className="container relative z-10 mx-auto max-w-6xl px-4">
        ...
        <FadeIn>
          ...
          >
            ...
            <div
              className="relative rounded-3xl border border-amber-500/20 p-12 text-center transition-all duration-500 group-hover:border-amber-500/40"
              style={{ 
                backgroundColor: "#0a0a0a",
                transform: "translateZ(0)",
        ...
        <div className="mt-24 text-center">
          <FadeIn>
            ...
            <div className="mt-8">
              ...
              <p className="mt-2 text-lg font-medium text-gray-500">Community of Security Leaders</p>
            </div>
          </FadeIn>
