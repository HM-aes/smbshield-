...
const Switch = ({ billingCycle, setBillingCycle }: { billingCycle: string; setBillingCycle: (cycle: string) => void }) => {
  return (
    <div className="relative mx-auto mt-8 flex w-fit items-center rounded-full border border-amber-500/20 bg-black/50 p-1">
      <button
...
export function PricingSection() {
  ...
  return (
    <section id="pricing" className="relative w-full overflow-hidden border-b border-gray-800 bg-black py-24">
      {/* Background effects */}
