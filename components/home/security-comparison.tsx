      ...
      <div className="relative flex-1 p-5 space-y-4 overflow-auto">
        ...
        <div className="flex justify-center px-4">
          <div className="w-full max-w-md">
            ...
            <div className="relative backdrop-blur-xl bg-black/70 border border-amber-500/40 shadow-[0_0_30px_rgba(245,158,11,0.2)] rounded-2xl p-6 space-y-5">
              {/* Header */}
              ...
              <div className="space-y-3">
                {/* Item 1 */}
                <div className="flex items-start gap-3 p-3 rounded-lg bg-black/50 border border-amber-500/20">
                ...
                <div className="flex items-start gap-3 p-3 rounded-lg bg-black/50 border border-amber-500/20">
                  ...
                  <div>
                    <div className="text-xs font-semibold text-gray-400 mb-1">Dev:</div>
                    <p className="text-sm text-gray-300 leading-relaxed">
      ...
      <div className="relative flex-1 p-5 space-y-4 overflow-auto">
        ...
        <div className="flex justify-center px-4">
          <div className="w-full max-w-md">
            ...
            <div className="relative backdrop-blur-xl bg-black/70 border border-cyan-500/40 shadow-[0_0_30px_rgba(6,182,212,0.2)] rounded-2xl p-6 space-y-5">
              {/* Header */}
              <div className="flex items-center gap-2">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3 p-3 rounded-lg bg-cyan-500/5 border border-cyan-500/20">
                  ...
                  <div>
                    <div className="text-xs font-semibold text-gray-400 mb-1">Primary:</div>
                ...
                <div className="flex items-start gap-3 p-3 rounded-lg bg-cyan-500/5 border border-cyan-500/20">
                  ...
                  <div>
                    <div className="text-xs font-semibold text-gray-400 mb-1">News:</div>
                    <p className="text-sm text-white leading-relaxed">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="relative group">
            ...
            <div className="relative bg-black rounded-[1.9rem] ring-1 ring-white/10 overflow-hidden">
              <CompareContent
