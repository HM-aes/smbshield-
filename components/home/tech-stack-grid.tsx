...
export function TechStackGrid() {
  return (
    <section className="relative w-full overflow-hidden border-b border-gray-800 bg-black py-24">
      {/* Background effects */}
            ...
            <div className="space-y-12 p-10 md:p-14">
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg leading-relaxed text-gray-400">
                  ...
                  <span className="font-medium text-white">Pydantic AI</span>{" "}
                  for bulletproof data validation and{" "}
                  <span className="font-medium text-white">FastAPI</span> for rock-solid, production-ready systems. These aren&apos;t just technical choices—they&apos;re{" "}
                ...
                <div className="flex flex-wrap gap-3">
                  {[
                    ...
                    <span
                      key={tag}
                      className="rounded-full border border-gray-700/50 bg-gray-800/50 px-4 py-2 text-sm font-medium text-gray-300 transition-all duration-300 hover:border-amber-500/30 hover:bg-amber-500/10 hover:text-amber-300"
                    >
                      {tag}
                    </span>
                  ))}
